...
namespace VRTK.Prefabs.Pointers
{
    ...
    /// </summary>
    public class PointerFacadeGameObjectExtractor : GameObjectExtractor<PointerFacade, PointerFacadeGameObjectExtractor.ExtractFromSurfaceData>
    {
        [Serializable]
        public class ExtractFromSurfaceData: UnityEvent<GameObject>
        {
