...
namespace VRTK.Prefabs.Pointers
{
    ...
    /// </summary>
    public class PointerFacadeComponentGameObjectExtractor : GameObjectExtractor<PointerFacade, PointerFacadeComponentGameObjectExtractor.ExtractGameObjectEvent>
    {
        [Serializable]
        public class ExtractGameObjectEvent: UnityEngine.Events.UnityEvent<GameObject>
        {
