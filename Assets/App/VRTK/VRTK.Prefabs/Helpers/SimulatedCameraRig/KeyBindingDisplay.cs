...
namespace Tilia.VRTKUI.Prefabs.CameraRig.SimulatedCameraRig
{
    ...
    public class KeyBindingDisplay : MonoBehaviour
    {
        ...
        // [Serialized]
        // [field: DocumentedByXml, Restricted]
        public UnityInputManagerButtonAction Right_TogglePointers;
        ...
        // [Serialized]
        // [field: DocumentedByXml, Restricted]
        public UnityInputManagerButtonAction Left_TogglePointers;
        /// <summary>
        ...
        Right Toggle Pointer: {14},
        Left Toggle Pointer {15}";
        ...
        protected virtual void OnEnable()
        {
            KeyBindingText.text = string.Format(
                ...
                Right_TogglePointers.KeyCode,
                Left_TogglePointers.KeyCode
                );
        }
    }
}