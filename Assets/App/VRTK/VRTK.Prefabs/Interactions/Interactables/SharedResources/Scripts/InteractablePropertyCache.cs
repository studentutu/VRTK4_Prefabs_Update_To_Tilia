...
namespace Tillia.VRTKUI.Prefabs.Interactions.Interactables
{
    ...
    public class InteractablePropertyCache : MonoBehaviour
    {
        ...
        public virtual void CacheRigidbodyKinematicState()
        {
            ...
            cachedRigidbodyKinematicState = Source.InteractableRigidbody != null ? Source.InteractableRigidbody.isKinematic : false;
        }
        ...
        public virtual void RestoreRigidbodyKinematicState()
        {
            ...
            Source.InteractableRigidbody.isKinematic = cachedRigidbodyKinematicState;
        }
